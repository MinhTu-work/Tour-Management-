...
public class TourController {
    ...
    public String tourCreate(Model model,
                             ...
                             BindingResult result, @RequestParam("file1") MultipartFile file1, @RequestParam("file2") MultipartFile file2) {
        ...
        if (action.equals("create")) {
            ...
            tourDto.setTourImg1(root + "\\" + file1.getOriginalFilename());
            tourDto.setTourImg2(root + "\\" + file2.getOriginalFilename());
